...
//    private Action preflopLevel; // what strategy will we be using for this hand
...
//        Action action = history.update(c1, c2, profit, preflopLevel.getValue(), curTable.getFlopAction(c1, c2).getValue());
