...
public class DetailedHoldemTableState extends AbstractGameState {
	...
	/**
	 * @return
	 * @see GameState#getCommunityCards()
	 */
	@Override
	 ...
	 * @param playerId
	 * @return
	 * @see GameState#getPlayer(PlayerId)
	 */
	@Override
	 ...
	 * @see GameState#getPreviousGameState()
	 */
	@Override
	...
	/**
	 * @return
	 * @see GameState#getPreviousRoundsPotSize()
	 */
	@Override
	...
	/**
	 * @return
	 * @see GameState#getTableConfiguration()
	 */
	@Override
