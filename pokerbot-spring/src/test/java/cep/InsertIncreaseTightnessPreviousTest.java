...
public class InsertIncreaseTightnessPreviousTest {
	...
	@Test
	public void insertIncreaseTightnessPreviousEvent() {
		...
		for (int i = 0; i < 5; i++) {
			events.add(new PlayerActionEvent("p1", Action.foldAction(0.0), true));
		}
